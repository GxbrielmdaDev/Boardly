      ...
      <div className="hidden lg:flex lg:w-1/2 relative overflow-hidden bg-gradient-to-br from-blue-600 via-blue-700 to-indigo-900 dark:from-blue-700 dark:via-indigo-800 dark:to-slate-900">
        ...
        <div className="relative z-10 flex flex-col justify-between p-16 w-full">
          <div className="flex items-center gap-3">
            <img src={boardlyLogo} alt="Boardly" className="h-14 w-auto brightness-0 invert" />
          ...
          <div className="space-y-6">
            <h1 className="text-4xl font-bold text-white leading-tight">
              ...
              <span className="text-blue-200">com simplicidade</span>
            </h1>
            <p className="text-blue-100/80 text-lg max-w-md leading-relaxed">
              Gerencie tarefas, colabore em tempo real e mantenha sua equipe alinhada com o Boardly.
            </p>
      ...
      <div className="flex-1 flex items-center justify-center p-8 bg-slate-50 dark:bg-slate-900 relative">
        ...
        <div className="w-full max-w-sm">
          <div className="flex items-center justify-center gap-3 mb-8 lg:hidden">
            <img src={boardlyLogo} alt="Boardly" className="h-8 w-auto" />
          ...
          <p className="text-slate-500 dark:text-slate-400 mb-8">Acesse sua conta para continuar</p>
